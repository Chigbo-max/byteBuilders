...
class CompoundInterestCalculator:
    ...
    def calculate_compound_interest(self):
        ...
        try:
            ...
            interest_factor_result = Calculation.getInterestFactorResult(interest_rate, compound_frequency, time)

            contribution_compound_interest = monthly_contribution * Calculation.get_interest_factor_from_contribution(interest_rate, compound_frequency,time)

            total_amount = Calculation.get_compound_interest(interest_factor_result, principal, self) + contribution_compound_interest
